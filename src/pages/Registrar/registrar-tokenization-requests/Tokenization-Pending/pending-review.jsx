...
function RegistrarTokenizationPendingReviewPage() {
  const { id } = useParams();
  ...
  const handleConfirmApprove = () => {
    ...
    console.log("Asset approved:", extendedAsset);
            ...
            <div className="">
              ...
              <div className=" rounded-lg  !px-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <p className="text-[11px] font-medium text-[#000]">Registration Status</p>
                ...
                <div className="mt-4 p-4 border border-[#E5E5EA] bg-gray-100 rounded-lg">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-[11px] font-medium text-[#000]">Submission Date</p>
                      <p className="text-[13px] font-medium text-[#000]">
                        {extendedAsset.date}
                      </p>
                    </div>
              ...
              <div className=" rounded-lg  !px-6 pt-6">
                ...
                <div className="space-y-3">
                  {/* <div className="flex items-center justify-between">
                    ...
                    <WalletAddress
                      value={extendedAsset.asset_contract_id??"TBD"}
                    />
                  </div> */}
                  <div className="flex items-center justify-between">
                    <p className="text-[11px] font-medium text-[#000]">Tokens</p>
                    <p className="text-[13px] font-medium text-[#000]">{extendedAsset.tokensMinted ?? "0"} Tokens</p>
                  </div>
                  <div className="flex items-center justify-between">
...
export default RegistrarTokenizationPendingReviewPage;
