...
const SuspendInvestorModal = ({ isOpen, onClose, investor, onConfirm }) => {
  const handleConfirm = () => {
    onConfirm?.();
    onClose();
  };
  ...
  return (
    <GenericModal
      ...
      subheader="Are you sure you want to temporarily suspend this Investor account?"
      maxWidth="max-w-lg"
    >
      {/* Asset Details */}
...
export default SuspendInvestorModal;
