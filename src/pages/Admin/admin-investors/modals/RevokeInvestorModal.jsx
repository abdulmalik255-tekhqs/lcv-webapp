...
const RevokeInvestorModal = ({ isOpen, onClose, investor, onConfirm }) => {
  const handleConfirm = () => {
    onConfirm?.();
    onClose();
  };
      ...
      <div className="mb-6 p-4 bg-gray-100 rounded-lg flex items-start gap-3 ">
        ...
        <div>
          ...
          <p className="text-[12px] text-[#000]">
            Revoking this Investor deletes all access, disables viewing and
            transacting, and prevents re-registration with the same credentials.
          </p>
        </div>
      </div>
...
export default RevokeInvestorModal;
