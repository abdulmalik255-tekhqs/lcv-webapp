...
const TransactionsReceiptModal = ({ isOpen, onClose, transaction }) => {
        ...
        <div>
          ...
          <div className="space-y-3">
            {[
              ...
              {
                label: "Block Number",
                value: transaction.blockNumber || "15808542",
              },
              {
                label: "Network",
                value: transaction.network || "Canton Network",
                isNetwork: true,
              },
              {
                label: "Requested Date",
                value: transaction.requestedDate || transaction.dateTime || transaction.date,
              },
              {
                label: "Verified Date",
                value: transaction.verifiedDate || transaction.dateTime || transaction.date,
              },
              {
                label: "Released Date",
                value: transaction.releasedDate || transaction.dateTime || transaction.date,
              },
            ].map((item, idx) => (
              <div
                key={idx}
...
export default TransactionsReceiptModal;
