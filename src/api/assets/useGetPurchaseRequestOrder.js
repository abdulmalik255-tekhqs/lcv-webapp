...
export const useGetPurchaseRequestOrder = (purchaseRequestId) => {
  ...
  return useQuery({
    queryKey: ["purchase-request-order", purchaseRequestId],
    queryFn: () => {
      return axiosInstance.get(urls.ASSETS.GET_PURCHASE_REQUEST_ORDER(purchaseRequestId));
    },
