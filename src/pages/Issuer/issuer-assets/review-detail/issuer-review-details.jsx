...
import IssuerReviewTokenizationTimeline from "./IssuerReviewTokenizationTimeline";

function IssuerAssetsReviewDetailsPage() {
  const { id } = useParams();
      ...
      <div className="p-4 sm:p-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 mb-6">
              <div>
              ...
              <div>
                ...
                <p className="text-[17px] font-normal text-[#000]">
                  {asset.assetBusinessDetail.minimum_investment || "0"}
                </p>
              </div>
            </div>
            <div className=" p-4">
          ...
          <div className="">
            ...
            <div className="!px-6 pt-6">
              <IssuerReviewTokenizationTimeline currentStep={3} />
            </div>
          </div>
        </div>
      </div>
...
export default IssuerAssetsReviewDetailsPage;
